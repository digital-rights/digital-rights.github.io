...
To learn and practice Markdown you can follow the tutorial below, to visit the tutorial on fullscreen [click here][ch].
...
Tools like [Pandoc](https://pandoc.org/) are extremely useful, but unintuitive for beginners. If you're not interested in Pandoc, try instead an online Ritch text to Markdown tool like [markitdown.medusis.com](http://markitdown.medusis.com/), shown below.
...
<iframe src="http://markitdown.medusis.com/" style="border:0px #ffffff none;" name="myiFrame" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="800px" width="600px" allowfullscreen></iframe>
